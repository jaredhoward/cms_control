...
ActiveRecord::Schema.define(:version => 20111127180801) do
  ...
  create_table "titan_control_users", :force => true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "titan_control_users", ["email"], :name => "index_titan_control_users_on_email", :unique => true
  add_index "titan_control_users", ["reset_password_token"], :name => "index_titan_control_users_on_reset_password_token", :unique => true
