...
page_products = TitanControl::CmsPage.create!({
  :status => 'published',
  :menu_title => 'Products',
  :cms_meta_attributes => {
    :url => 'products.html',
...
page_applications = TitanControl::CmsPage.create!({
  :status => 'published',
...
page_sales = TitanControl::CmsPage.create!({
  :status => 'published',
  :menu_title => 'Sales',
  :cms_meta_attributes => {
    :url => 'sales.html',
...
page_support = TitanControl::CmsPage.create!({
  :status => 'published',
  :menu_title => 'Support',
  :cms_meta_attributes => {
    :url => 'support.html',
...
page_partners = TitanControl::CmsPage.create!({
  :status => 'published',
  :menu_title => 'Partners',
  :cms_meta_attributes => {
    :url => 'partners.html',
...
page_corporate = TitanControl::CmsPage.create!({
  :status => 'published',
...
page_contact = TitanControl::CmsPage.create!({
  :status => 'published',
  :menu_title => 'Contact',
  :cms_meta_attributes => {
    :url => 'contact',
...
page_legal = TitanControl::CmsPage.create!({
  :status => 'published',
  :cms_meta_attributes => {
    :url => 'legal',
...
page_whyv34 = TitanControl::CmsPage.create!({
  :status => 'published',
  :cms_meta_attributes => {
    :url => 'whyv34',
...
page_software = TitanControl::CmsPage.create!({
  :status => 'published',
  :cms_meta_attributes => {
    :url => 'software',
...
block_default = TitanControl::CmsBlock.create!({
...
block_home_iq_express_information = TitanControl::CmsBlock.create!({
...
block_home_how_do_i = TitanControl::CmsBlock.create!({
  :title => '(Home) How do I?',
  :cms_contents_attributes => [
    {
      :status => 'published',
...
block_home_latest_news = TitanControl::CmsBlock.create!({
...
block_home_how_to_buy = TitanControl::CmsBlock.create!({
...
block_products_more_infomation = TitanControl::CmsBlock.create!({
...
block_applications_more_information = TitanControl::CmsBlock.create!({
...
block_sales_more_information = TitanControl::CmsBlock.create!({
...
block_support_more_information = TitanControl::CmsBlock.create!({
...
block_partners_more_information = TitanControl::CmsBlock.create!({
...
block_corporate_more_information = TitanControl::CmsBlock.create!({
...
block_contact_more_information = TitanControl::CmsBlock.create!({
...
block_legal_more_information = TitanControl::CmsBlock.create!({
...
block_whyv34_in_this_document = TitanControl::CmsBlock.create!({
...
block_software_more_information = TitanControl::CmsBlock.create!({
...
block_software_operating_systems = TitanControl::CmsBlock.create!({
